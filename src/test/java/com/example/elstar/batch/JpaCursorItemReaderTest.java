...
class JpaCursorItemReaderTest {
    ...
    void testReaderReadsAllItems() throws Exception {
        repository.save(new ElstarData("<xml>Test 1</xml>"));
        repository.save(new ElstarData("<xml>Test 2</xml>"));
        repository.save(new ElstarData("<xml>Test 3</xml>"));
    ...
    void testReaderReadsItemWithLongXmlContent() throws Exception {
        ...
        repository.save(new ElstarData(longXml));
